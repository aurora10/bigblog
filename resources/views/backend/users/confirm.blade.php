            ...
            <div class="row">
                ...
                <div class="col-xs-9">
                    ...
                    <div class="box-body ">
                        ...
                        <p>What should be done to the content owned by this user ?</p>
                        <p>
                            <input type="radio" name="delete-option" value="delete" checked> Delete all content


                        </p>
                        <p> <input type="radio" name="delete-option" value="attribute"> Attribute content to :
